...
<div id="header-wrapper" >
	...
	<div id="menu-wrapper" class="color">
        ...
        <li><a href="music.php" accesskey="2" >Music</a></li>
        <li><a href="leaderboard.html" accesskey="3">Leaderboard</a></li>
        <li class="current_page_item"><a href="search.php" accesskey="4">Search</a></li>
        <li><a href="login.html" accesskey="5" >Log In</a></li>
      </ul>
		</div>
	</div>
</div>
                ...
                while($j<$i)
                {
                  ...
                  else
                  {
                     ...
                     echo'<tr> 
                            ...
                            <th><a href="notlog.html">Detail</a></th>
                          </tr>';
